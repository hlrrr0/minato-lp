...
/* 初期設定 */
//管理者メールアドレス（届け先）
$AdminMailAddress = "y_sasaki@minato-kaihatsu.com,m_suzuki@minato-kaihatsu.com";
//メールの送信元名前（ユーザーに見せる名称）
$FromName = "株式会社港開発お問い合わせ窓口";
//メールの送信元アドレス（ユーザーに見せるアドレス）
$FromMail = "y_sasaki@minato-kaihatsu.com";

//管理者メール設定
//件名
$AdminMailSubject = "【お問い合わせ】借地権・底地権付不動産LP";
//本文
$AdminMailBody = '借地権・底地権付不動産LPに
お客様からお問い合わせがありました。
...
//ユーザーへのメール設定
//件名
$UserMailSubject = "借地権・底地権付不動産ご売却のお問い合わせありがとうございます。";
//本文
$UserMailBody = '{%%Name%%}様
